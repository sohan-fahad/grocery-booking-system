...
export const ENV = {
    ...
    adminSecret: process.env.ADMIN_SECRET || '12345678',
    api: {
    ...
    storage: {
        type: process.env.FILE_STORAGE || 'r2',
        localBase: process.env.FILE_STORAGE_LOCAL_BASE,
    },
    r2: {
        ...
        cdnEndpoint: process.env.R2_CDN_ENDPOINT,
    },
